...
$sql = mysqli_query($conn, "SELECT r.status,g.guest_id,g.first_name,g.last_name,g.contact_number,g.email,g.addressline_1,g.city,g.zipcode,r.reservation_id,r.billing_id,r.booking_reference,r.num_guest,r.reservation_date,r.checkin_date,r.checkout_date,r.expiration_date,count(rp.receipt_photo_id) as num_uploaded_recpt
FROM reservation r 
